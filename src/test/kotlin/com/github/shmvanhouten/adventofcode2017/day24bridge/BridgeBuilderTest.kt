...
class BridgeBuilderTest {
    ...
    fun `it should build a bridge from the two components`() {
        ...
        assertThat(bridgeBuilder.buildStrongestPossibleBridge(bridgeComponents), equalTo(8))
    }
    ...
    fun `it should build a bridge from these components to get a strongest bridge of 31`() {
        ...
        val bridgeBuilder = BridgeBuilder()
        assertThat(bridgeBuilder.buildStrongestPossibleBridge(bridgeComponents), equalTo(31))
    }
    ...
    fun `it should solve the challenge input`() {
        ...
        val bridgeBuilder = BridgeBuilder()
        assertThat(bridgeBuilder.buildStrongestPossibleBridge(bridgeComponents), equalTo(2006))
    }
