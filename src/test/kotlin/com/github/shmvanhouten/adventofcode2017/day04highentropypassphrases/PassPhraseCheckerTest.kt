...
class PassPhraseCheckerTest {
    ...
    @Test
    fun `it should say the phrase is valid`() {
        val checker = PassPhraseCheckerIdenticalImpl()
        assertThat(checker.checkIfItIsAValidPhrase("aa bb cc dd ee"), equalTo(true))
    }

    @Test
    fun `it should say the phrase aa bb cc dd aa is not valid`() {
        val checker = PassPhraseCheckerIdenticalImpl()
        assertThat(checker.checkIfItIsAValidPhrase("aa bb cc dd aa"), equalTo(false))
    }

    @Test
    fun `it should say the phrase aa bb cc dd aaa is valid`() {
        val checker = PassPhraseCheckerIdenticalImpl()
        assertThat(checker.checkIfItIsAValidPhrase("aa bb cc dd aaa"), equalTo(true))
    }

    @Test
    fun `it should count the amount of valid phrases to be 2`() {
        val checker = PassPhraseCheckerIdenticalImpl()
        val phrases = """aa bb cc dd ee
aa bb cc dd aaa
aa bb cc dd aa"""
        assertThat(checker.countValidPhrases(phrases), equalTo(2))
    }

    @Test
    fun `it should count the amount of valid phrases 466 to be for the challenge input`() {
        val checker = PassPhraseCheckerIdenticalImpl()

        assertThat(checker.countValidPhrases(day04ChallengeInput), equalTo(466))
    }
...
val day04ChallengeInput = """pphsv ojtou brvhsj cer ntfhlra udeh ccgtyzc zoyzmh jum lugbnk
